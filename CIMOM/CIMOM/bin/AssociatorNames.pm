...
sub test1 {
    ...
    return "AssociatorNames with a CIM::Class as query ($objectName)\n    and with default settings\n    (returns the associated classes)"
	if @_;
...
sub test2 {
    ...
    return "AssociatorNames with a non existent CIM::Class as query ($objectName)"
	if @_;
...
sub test3 {
    ...
    return "AssociatorNames with a CIM::Instance as query ($on)\n    and with default settings\n    (returns the associated instances)"
	if @_;
